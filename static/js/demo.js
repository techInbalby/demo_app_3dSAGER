...
// Expose selectedFile + selectedBuildingId on window as live getters, so
// building-colors.js (and other extracted modules) can read the current
// value without us syncing on every assignment. The local `let` stays the
// canonical write target inside demo.js.
Object.defineProperty(window, 'selectedFile', {
    get: () => selectedFile,
    configurable: true,
});
Object.defineProperty(window, 'selectedBuildingId', {
